    ...
    return (
        <div className="relative cursor-pointer p-4 bg-white shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] rounded-xl group" onClick={onClick}>
            ...
            <div className="mt-4 text-center">
                <h3 className="text-[16px] sm:text-[18px] md:text-[20px] font-bold text-[#000000]">
                    {testimonial.quote}
                </h3>
            </div>
        </div>
...
export default function ReverseFunnelSection() {
    ...
    return (
        <>
            <section className="w-full bg-[#F8FAFF] py-2 md:-mt-24 mt-12">
                <div className="mx-auto max-w-[1120px] px-4">
                    <h2 className="text-[22px]  text-center  lg:text-[38px] font-extrabold leading-[1.5] text-[#000000] mb-4">                 After ₹65+ Crores In Sales Online…&nbsp;

                        For The First Time, Learn This System LIVE &amp; In-Person to<br className='md:hidden'/> Hit Your <span className="thin-underline">₹1 CR Goal in 2025</span></h2>
             


                    {/* Testimonial Videos */}
                    <div className="grid grid-cols-1 mt-12 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12">
