        ...
        <section className="w-full  pt-12">
            <div className="mx-auto max-w-[1200px] px-4">
                ...
                <div className="text-center">
                    <h2 className="text-[24px]   lg:text-[38px] font-extrabold leading-[1.5] text-[#000000] mb-4">
                        These AI Funnel Strategies Can Bombard Your Inbox With Payment Notifications Like This…{' '}
                ...
                {/* Main Content Grid */}
                <div className="grid grid-cols-1 mt-8 items-center lg:grid-cols-2 -8  items- ">
