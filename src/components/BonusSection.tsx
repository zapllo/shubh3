...
function BonusCard({ bonusNumber, title, items, image, priceText, backgroundColor = "bg-[#353943]" }: BonusCardProps) {
    return (
        <div className={`${backgroundColor} rounded-xl h-full mb-12 -lg overflow- relative`}>
            ...
            <div className="relative rounded-xl p-6">
                ...
                <div className="bg-[#13B3E6]   absolute top-0 left-0 md:p-3 p-3 rounded-l-lg rounded-bl-none rounded-br-lg">
                    <h3 className="md:text-xl mt-2 text-white font-bold">{bonusNumber}</h3>
                </div>
                {/* </div> */}
            ...
            {/* Content */}
            <div className="p-6 bg-[#353943] rounded-xl pt-0">
                {/* Title with Icon */}
                <div className="flex items-center justify-center text-center gap-3 mb-4">
                    {/* <VerticalLine height="h-8" /> */}
                    <h3 className="text-[22px] text-center  font-bold text-[#ffffff] leading-tight">
                        {title}
                    </h3>
                </div>
            ...
            <div className=' text-center  absolute bottom-0 w-full rounded-b-xl md:text-3xl font- p-4 text-lg text-[#00e500]'>
                <span>
                    FREE
                </span>
            </div>
...
const bonusData = [
    {
        ...
        image: "https://lp.launchatscale.com/wp-content/uploads/2025/06/bonus1_shubh.webp",
    ...
    },
    {
        ...
        image: "https://lp.launchatscale.com/wp-content/uploads/2025/06/bonus_2_shubh.webp",
    ...
    },
    {
        ...
        image: "https://lp.launchatscale.com/wp-content/uploads/2025/06/bonus3_shubh.webp",
        priceText: "<span style='font-size:20px'>PRICELESS</span>",
        items: [
    ...
    },
    {
        ...
        image: "https://lp.launchatscale.com/wp-content/uploads/2025/06/shubh_4_bonus.webp",
        priceText: "<span style='font-size:20px'>PRICELESS</span>",
        items: [
...
export default function BonusSection() {
    return (
        <section className="w-full bg-[#040B1A] py-2 mt-12  relative overflow-hidden">
            {/* Decorative Icons */}
            ...
            <div className="mx-auto max-w-[1200px] px-4">
                ...
                <div className="text-center mb-12 sm:mb-16">
                    <h2 className="text-[24px] sm:text-[28px] md:text-[32px] lg:text-[36px] font-bold text-[#ffffff] leading-[1.2] mb-6">
                        Get Insane Bonus
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 space-y-12 ">
                    {bonusData.map((bonus, index) => (
                        <BonusCard
                            ...
                            backgroundColor={index % 2 === 0 ? "bg-[#353943]" : "bg-[#353943]"}
                        />
                    ))}
                </div>
                <div className='mt-12'>
